...
$hasil = $koneksi_db->sql_query( "UPDATE akad_useraura SET email='$email', password='$password3' WHERE user='$user'" );

$tengah.='<div class="sukses"><b>Informasi Admin telah di updated</b><br />Silahkan <a href="?aksi=logout" target="_top">Logout</a> kemudian <a href="?pilih=login" target="_top">Login</a> lagi!</div>';
}
