...
$tgl1 		= $_GET['tgl1'];
$tgl2 		= $_GET['tgl2'];
echo "<html><head><title>Cetak Pelanggaran Siswa</title>";
...
<center>
  <font size="4"><strong>LAPORAN PELANGGARAN SISWA</strong></font><br />
 </center><br /><br />
<table>
';
	...
	<table align="center" class="tab" id="table" border="1" style="border-collapse:collapse" width="99%" align="left" bordercolor="#000000">
   	<tr height="30" align="center">
        ...
        <td width="5%" class="header">Kelas</td>
   		<td width="10%" class="header">Kategori</td>
   		<td class="header">Pelanggaran</td>
		<td width="5%" class="header">Point</td>                
        <td class="header">Keterangan</td>  	
    </tr>';
	$no = 1;
$hasil = $koneksi_db->sql_query( "SELECT * FROM akad_siswapelanggaran where tgl between '$tgl1' and '$tgl2' and  siswa='$idsiswa' order by tgl asc" );
...
echo '<tr height="25">    	
        ...
        <td align="left">'.getkatdaripelanggaran2($pelanggaran).'</td>
		<td align="left">'.getpelanggaran($pelanggaran).'</td>
       	<td align="center">'.$point.'</td>       
        <td align="left">'.gethukuman($pelanggaran).'</td>
    </tr>';
$pointtotal +=$point;
	$no++;
}
echo '<tr>	
		<td width="5%" colspan="5" align="right" bgcolor="#CCCCCC"><strong>Jumlah&nbsp;&nbsp;</strong></td>
   		<td width="5%" height="25" align="center">'.$pointtotal.'</td>     
